...
export class ToolboxController {
    ...
    public subscribe(bus: EventBus<SemanticEventMap>) {
        ...
        bus.on(SemanticEvents.ToolStartUsing, (e) => { this.onToolStartUsing(e, bus) });
        bus.on(SemanticEvents.ToolProcessUsing, (e) => { this.onToolProcessUsing(e, bus) });
        bus.on(SemanticEvents.ToolEndUsing, () => { this.onToolEndUsing(bus) });
    }
