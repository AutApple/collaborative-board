...
const signUpConfirmPasswordInputErrorBoxText = document.getElementById('confirm-password-input-error-content');
...
function isSignUpFieldErrorMapKey(
    key: string
): key is keyof typeof signUpFieldToErrorContainerMap {
