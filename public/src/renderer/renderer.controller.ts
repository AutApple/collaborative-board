...
import { SemanticEvents, type EventBus, type RendererExportBoardEvent, type RendererRedrawBoardEvent, type SemanticEventMap } from '../event-bus/index.js';
import type { RendererUiAdapter } from './renderer.ui-adapter.js';

export class RendererController {
    constructor (private appContext: AppContext, private uiAdapter: RendererUiAdapter) { }
    ...
    onRendererRedrawBoard(e: RendererRedrawBoardEvent) {
        this.appContext.renderer.refreshBoardLayersAndRender(this.appContext.camera, e.elements, e.debugStats);
    }
