...
export class RoomRepository extends BaseRepository<Room> {
    ...
    private roomModelToInstance(roomModel: RoomModel & { board: BoardModel & { elements?: BoardElementModel[]; } }): Room {
    ...
    public async get(id: string): Promise<Room | null> {
        ...
        const roomModel = await this.client.room.findUnique({ where: { id }, include: { board: { include: { elements: true } } } });
